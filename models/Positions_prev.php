...
class Positions_prev
{
    ...
    public function read()
    {
        $columns = $this->table . '.position_prev_id, ' . $this->table . '.user_id, '
            ...
            . $this->departments . '.department, ' . $this->table . '.position_present_where, '
            . $this->table . '.position_present_from, ' . $this->table . '.position_present_to';
    ...
    public function create()
    {
        $query = 'INSERT INTO ' . $this->table
            . ' SET user_id = :user_id, phone = :phone, address = :address, position_id = :position_id, 
                department_id = :department_id, position_present_where = :position_present_where, 
                position_present_from = :position_present_from, position_present_to = :position_present_to';
        ...
        $this->position_present_to = htmlspecialchars(strip_tags($this->position_present_to));
        ...
        $stmt->bindParam(':position_present_to', $this->position_present_to);
