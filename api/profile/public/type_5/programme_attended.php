...
class Programme_attended_api
{
    ...
    public function get_by_id()
    {
        ...
        $all_data = $this->Programme_attended->read_by_id();
    ...
    {
        if (!$this->Programme_attended->create()) {
    ...
    public function update($DB_data, $to_update, $update_str)
    {
        if (strcmp($DB_data, $to_update) !== 0) {
            if (!$this->Programme_attended->update($update_str)) {
        ...
        while ($count < count($data)) {
            ...
            foreach ($DB_data as $key => $element) {
                if ($element['programme_attended_id'] == $data[$count]->programme_attended_id) {
                    ...
                    $this->update($element['programme_attended'], $data[$count]->programme_attended, 'programme_attended');
                    $this->update($element['programme_attended_from'], $data[$count]->programme_attended_from, 'programme_attended_from');
                    $this->update($element['programme_attended_to'], $data[$count]->programme_attended_to, 'programme_attended_to');
