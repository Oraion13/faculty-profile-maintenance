...
const positions_prev = [
    {
        ...
        "position_prev_from": "1993-05",
        "position_prev_to": "2000-07"
    },
    {
        "position_prev_id": 19,
        "position_id": 5,
        ...
        "position_prev_from": "2001-05",
        "position_prev_to": "2003-07"
    }, {
        "position_prev_id": 18,
        "position_id": 4,
        "department_id": 2,
        "position_prev_where": "College of Engineering Trichy, Anna University, Trichy",
        "position_prev_from": "2004-05",
        "position_prev_to": "2008-08"
    },
    {
        "position_prev_id": 20,
        "position_id": 5,
        ...
        "position_prev_from": "2010-11",
        "position_prev_to": "2015-08"
    }
]
...
const additional_responsibilities_prev = [
    {
        ...
        "additional_responsibility_prev_from": "2005-09",
    ...
    },
    {
        ...
        "additional_responsibility_prev_from": "2012-05",
        "additional_responsibility_prev_to": "2015-03"
    }
]
...
const other_employment = [
    {
        ...
        "other_employment_from": "2001-09",
        "other_employment_to": "2009-03"
    },
    {
        "other_employment_id": 3,
        "other_employment": "Professor, CEG",
        "other_employment_from": "2010-09",
        "other_employment_to": "2015-03"
    }
]
...
const programme_attended = [
    {
        ...
        "programme_attended_from": "2002-09",
        "programme_attended_to": "2002-09"
    },
    {
        ...
        "programme_attended_from": "2005-09",
...
const programme_chaired = [
    {
        ...
        "programme_chaired_from": "2002-09",
        "programme_chaired_to": "2002-09"
    },
    {
        ...
        "programme_chaired_from": "2005-09",
...
const programme_organized = [
    {
        ...
        "programme_organized_from": "2002-09",
        "programme_organized_to": "2002-09"
    },
    {
        ...
        "programme_organized_from": "2005-09",
...
const special_reprasentations = [
    {
        ...
        "special_reprasentation_from": "2002-09",
        "special_reprasentation_to": "2002-10"
    },
    {
        ...
        "special_reprasentation_from": "2005-09",
...
const exp_abroad = [
    {
        ...
        "exp_abroad_from": "2012-08",
        "exp_abroad_to": "2012-10",
        "purpose_of_visit": ""
    },
    {
        "exp_abroad_id": 1,
        "exp_abroad": "Visited WORLDCOMP-16 , USA",
        "exp_abroad_from": "2016-06",
        "exp_abroad_to": "",
...
const research_degree = [
    {
        ...
        "research_degree_from": "2001-08",
        "research_degree_to": "2007-10",
    ...
    },
    {
        ...
        "research_degree_from": "2007-08",
        "research_degree_to": "2014-10",
...
const extension_outreach = [
    {
        ...
        "extension_outreach_from": "2001-08",
        "extension_outreach_to": "2003-10",
...
const photo = {
    "photo": "send the photo" // in js, use FormData()
}

/* ------------------------------------- Invigilation duties ------------------------------ */

const invigilation_duties = [
    {
        "invigilation_duty_id": 0, // For new data
        "invigilation_duty": "description...",
        "invigilation_duty_at": "2011-05"
    },
    {
        "invigilation_duty_id": 2,
        "invigilation_duty": "description...",
        "invigilation_duty_at": "2002-02"
    }
]
...
const onduty_orders = [
    {
        "onduty_order_id": 0, // For new data
        "onduty_order": "description...",
        "onduty_order_at": "1998-08"
    },
    {
        "onduty_order_id": 5,
        "onduty_order": "description...",
        "onduty_order_at": "2000-01"
    }
]

/* -------------------------------- Incharge duty files -------------------------------- */

const incharge_duty_files = { // use js FormData()
    "name": "why this file?",
    "incharge_duty_file": "send the file",
    "incharge_duty_file_at": "2015-02"
}
