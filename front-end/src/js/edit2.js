...
const edit2_form = document.getElementById("edit2_form");
...
const position_present_where = document.getElementById("position_present_where");
const position_present_from = document.getElementById("position_present_from");

edit2_form.addEventListener("submit", register);
...
function register(e) {
    ...
    xhr.open("POST", "../../api/profile/public/type_0/user_info.php", true);
