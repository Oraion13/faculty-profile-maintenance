    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState == XMLHttpRequest.DONE) {
        ...
        if (got.error) {
          ...
          element4.innerHTML = `
          <td></td>
              <td>${got.position}, ${got.department}, ${
...
function generate_jsPdf() {
  return new Promise((resolve, reject) => {
    doc.autoTable({
      html: "#table_faculty",
      theme: "grid",
      bodyStyles: { lineColor: [255, 255, 255], fillColor: false },
      startY: 60,
      ...
      didDrawPage: function (data) {
        ...
        doc.setTextColor(40);
        doc
          .text(195, 7, `${faculty_name}`, { align: "right" })
          .setFont(undefined, "bold");
        // doc.line(1, 12, 4, 4);
        doc
          .text(195, 11, `${faculty_dept}`, { align: "right" })
          .setFont(undefined, "bold");
        ...
        doc.rect(
          ...
          doc.internal.pageSize.height - 19,
          "S"
        );
        doc.rect(
          11,
          ...
          doc.internal.pageSize.height - 21,
          "S"
        );
      },
      // headStyles: {
